                ...
                <CardContent className="p-4">
                  ...
                  <View className="space-y-3">
                    ...
                    <View className="flex-row justify-between items-center">
                      ...
                      <Text className="text-white font-semibold">${offer.offeredPricePerTon}/ton</Text>
                    </View>
              ...
              <View className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-3 mb-4">
                <View className="flex-row items-start">
                  ...
                  <Text className="text-orange-400 text-sm ml-2 flex-1">
                    Rejecting this offer will end the negotiation. The buyer will be notified and cannot make another offer for this transaction.
                  </Text>
                </View>
              </View>
              ...
              <View className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-3 mb-4">
                <View className="flex-row items-start">
                  ...
                  <View className="ml-2 flex-1">
                    <Text className="text-blue-300 text-sm font-semibold mb-1">Professional tip:</Text>
                    <Text className="text-blue-300 text-xs">
                      Being clear about your reasons helps maintain good business relationships and may lead to future opportunities.
                    </Text>
                  </View>
                </View>
              </View>
          ...
          <View className="p-6 border-t border-neutral-700">
            <View className="flex-row gap-3">
              ...
              <TouchableOpacity
                ...
                disabled={isLoading || !selectedReason || (selectedReason === 'Other' && !rejectReason.trim())}
                className={`flex-1 rounded-lg py-3 items-center justify-center ${
                  isLoading || !selectedReason || (selectedReason === 'Other' && !rejectReason.trim())
                    ? 'bg-neutral-600'
