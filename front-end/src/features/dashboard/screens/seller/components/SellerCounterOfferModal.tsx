...
interface SellerCounterOfferModalProps {
  ...
  onConfirm: (negotiationId: string, counterPrice: number, quantity?: number, message?: string) => void;
  isLoading?: boolean;
}
              ...
              <View className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-3 mb-4">
                <View className="flex-row items-start">
                  ...
                  <View className="ml-2 flex-1">
                    <Text className="text-blue-300 text-sm font-semibold mb-1">Negotiation Tips:</Text>
                    <Text className="text-blue-300 text-xs">
                      • Justify your counter with quality, freshness, or service value{'\n'}
                      • Consider market conditions and seasonal pricing{'\n'}
                      • Be reasonable to maintain the business relationship
                    </Text>
                  </View>
                </View>
              </View>
