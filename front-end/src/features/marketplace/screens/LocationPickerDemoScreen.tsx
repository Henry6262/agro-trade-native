    ...
    <ScrollView className="flex-1 bg-gray-900">
      <View className="p-4">
        <Text className="text-white text-2xl font-bold mb-2">
          Location Map Picker Demo
        </Text>
        <Text className="text-gray-400 mb-6">
          Tap on the map to select a location. The component will automatically reverse geocode the coordinates to get the address.
        </Text>
          ...
          <View className="mt-6 bg-gray-800 rounded-lg p-4">
            ...
            <View className="space-y-2">
              <Text className="text-gray-300">
                <Text className="font-medium">Coordinates:</Text> {selectedLocation.latitude.toFixed(6)}, {selectedLocation.longitude.toFixed(6)}
              </Text>
        ...
        {confirmedLocation && (
          <View className="mt-4 bg-green-900/30 border border-green-600 rounded-lg p-4">
            ...
            <Text className="text-green-300">
              {confirmedLocation.formattedAddress || `${confirmedLocation.latitude}, ${confirmedLocation.longitude}`}
            </Text>
          </View>
        )}
        ...
        <View className="mt-4 bg-gray-800 rounded-lg p-4">
          ...
          <View className="space-y-1">
            ...
            <Text className="text-gray-300 text-sm">
              ✓ Customizable UI with confirmation flow
            </Text>
            <Text className="text-gray-300 text-sm">
