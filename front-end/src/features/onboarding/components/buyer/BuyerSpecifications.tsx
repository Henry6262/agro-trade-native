...
import { ProductSpecificationInput } from '../shared/ProductSpecificationInput'
  ...
  useEffect(() => {
    if (selectedProductId) {
      ...
      try {
        ...
        const existingSpec = specifications.find(s => s.productId === selectedProductId) || currentSpecs
        if (existingSpec) {
