      ...
      <View className="bg-white/30 rounded-2xl p-5 mb-6 border border-gray-200/50">
        ...
        <View className="mb-4">
          <View className="flex-row items-center mb-3">
            ...
            <Text className="text-gray-900 text-xl font-bold ml-2">Purchase Quantity</Text>
          </View>
        ...
        <View className="mb-4">
          <View className="flex-row items-center mb-3">
            ...
            <Text className="text-gray-900 text-xl font-bold ml-2">Maximum Price</Text>
          </View>
        ...
        {currentQuantity > 0 && currentPrice && parseFloat(currentPrice) > 0 && (
          <View className="bg-blue-600/10 rounded-xl p-4 mt-4 border border-blue-600/20">
            ...
            <View className="flex-row justify-between mb-1">
              ...
              <Text className="text-gray-900 font-medium">€{currentPrice}/kg</Text>
            </View>
