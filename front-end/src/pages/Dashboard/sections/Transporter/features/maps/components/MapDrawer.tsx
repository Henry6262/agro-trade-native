              ...
              <View className="rounded-lg overflow-hidden mt-4" style={{ height: 400 }}>
                {offer && (
                  <MapView
                    ...
                    style={{ flex: 1 }}
                    initialRegion={{
                      latitude: (offer.pickup.coordinates.latitude + offer.delivery.coordinates.latitude) / 2,
                      longitude: (offer.pickup.coordinates.longitude + offer.delivery.coordinates.longitude) / 2,
                      latitudeDelta: 0.15,
                      longitudeDelta: 0.15,
                    }}
                  ...
                  >
                    ...
                    {routes.map((route, index) => {
                      ...
                      return (
                        ...
                        >
                          <View className="bg-white rounded-full p-2.5 shadow-lg border-2" style={{ borderColor: route.color }}>
