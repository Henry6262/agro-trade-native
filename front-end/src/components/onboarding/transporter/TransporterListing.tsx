      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1, padding: 16 }} showsVerticalScrollIndicator={false}>
        <View style={{ paddingBottom: 96 }}>
          <View style={{ alignItems: 'center', marginBottom: 32 }}>
            ...
            <Text style={{ fontSize: 28, fontWeight: 'bold', color: '#FFFFFF', textAlign: 'center', marginBottom: 12 }}>Ready to Transport</Text>
            <Text style={{ color: '#9CA3AF', maxWidth: 600, textAlign: 'center', fontSize: 16 }}>
              Your transportation profile is ready! Review your details and create your listing to start connecting with buyers and sellers.
            </Text>
          </View>

          <Card style={{ padding: 24, backgroundColor: 'rgba(234, 88, 12, 0.1)', borderColor: '#ea580c', marginBottom: 32 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <View style={{ width: 48, height: 48, backgroundColor: 'rgba(234, 88, 12, 0.2)', borderRadius: 8, alignItems: 'center', justifyContent: 'center', marginRight: 16 }}>
                  <Truck size={24} color="#ea580c" />
                </View>
                <View>
                  <Text style={{ fontSize: 18, fontWeight: '600', color: '#FFFFFF' }}>Fleet Overview</Text>
          ...
          <Card style={{ padding: 24, backgroundColor: 'rgba(37, 99, 235, 0.1)', borderColor: '#2563eb', marginBottom: 32 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <View style={{ width: 48, height: 48, backgroundColor: 'rgba(37, 99, 235, 0.2)', borderRadius: 8, alignItems: 'center', justifyContent: 'center', marginRight: 16 }}>
                  <MapPin size={24} color="#2563eb" />
                </View>
                <View>
                  <Text style={{ fontSize: 18, fontWeight: '600', color: '#FFFFFF' }}>Service Area</Text>
                  <Text style={{ color: '#9CA3AF' }}>
          ...
          {fleetInfo?.vehicleTypes && fleetInfo.vehicleTypes.length > 0 && (
            <View style={{ marginBottom: 32 }}>
              <Text style={{ fontSize: 18, fontWeight: '600', color: '#FFFFFF', marginBottom: 16 }}>Vehicle Details</Text>
              <View>
                {fleetInfo.vehicleTypes.map((vehicle, index) => (
                  <Card key={vehicle.id} style={{ padding: 16, backgroundColor: '#1F2937', borderColor: '#374151', marginBottom: 12 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                      <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <View>
                          <Text style={{ fontWeight: '600', color: '#FFFFFF' }}>
                            {vehicle.type} Truck {index + 1}
                          </Text>
                          <Text style={{ fontSize: 14, color: '#9CA3AF' }}>
                            {vehicle.capacity} {vehicle.unit} capacity
                          </Text>
                        </View>
                      </View>
                    </View>
          ...
          <View style={{ marginBottom: 32 }}>
            <Text style={{ fontSize: 18, fontWeight: '600', color: '#FFFFFF', marginBottom: 16 }}>Market Insights</Text>
            <View>
              <Card style={{ padding: 24, alignItems: 'center', backgroundColor: '#1F2937', borderColor: '#374151', marginBottom: 16 }}>
                <View style={{ width: 48, height: 48, backgroundColor: 'rgba(34, 197, 94, 0.2)', borderRadius: 8, alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
              ...
              <Card style={{ padding: 24, alignItems: 'center', backgroundColor: '#1F2937', borderColor: '#374151', marginBottom: 16 }}>
                <View style={{ width: 48, height: 48, backgroundColor: 'rgba(37, 99, 235, 0.2)', borderRadius: 8, alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
              ...
              <Card style={{ padding: 24, alignItems: 'center', backgroundColor: '#1F2937', borderColor: '#374151', marginBottom: 16 }}>
                <View style={{ width: 48, height: 48, backgroundColor: 'rgba(234, 88, 12, 0.2)', borderRadius: 8, alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
          ...
          <View style={{ alignItems: 'center', paddingTop: 32 }}>
            <TouchableOpacity
              ...
              activeOpacity={0.8}
            >
              <Text style={{ color: 'white', fontSize: 18, fontWeight: '600' }}>Create Transportation Listing</Text>
            </TouchableOpacity>
