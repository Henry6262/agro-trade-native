...
const styles = StyleSheet.create({
  ...
  summaryRow: { alignItems: 'center', flexDirection: 'row', gap: 10, marginBottom: 10 },
  summaryText: { color: COLORS.textPrimary, flex: 1, fontSize: 14 },
  timeline: { flexDirection: 'row', justifyContent: 'space-between' },
  timelineCard: { marginBottom: 16, padding: 16 },
  timelineDot: {
    alignItems: 'center',
    borderRadius: 16,
    borderWidth: 2,
