import {
  getOfferMapData,
  getMultipleOffersMapData,
} from '../../../../src/features/dashboard/screens/transporter/maps/api/offerApi';
...
describe('Offer Map Data Contract', () => {
  describe('GET /api/offers/:id/map-data', () => {
    ...
    it('should handle non-existent offer ID', async () => {
      await expect(getOfferMapData('non-existent-offer')).rejects.toThrow('Offer not found');
    });
