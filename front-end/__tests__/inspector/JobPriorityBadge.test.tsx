...
describe('JobPriorityBadge', () => {
  ...
  it('should render MEDIUM priority with yellow background', () => {
    const { getByTestId, getByText } = render(
      <JobPriorityBadge priority="MEDIUM" />
    );
  ...
  it('should apply custom size', () => {
    const { getByTestId } = render(
      <JobPriorityBadge priority="HIGH" size="large" />
    );
  ...
  it('should apply custom className', () => {
    const { getByTestId } = render(
      <JobPriorityBadge priority="MEDIUM" className="custom-class" />
    );
