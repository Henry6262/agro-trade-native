...
jest.mock('react-native-maps', () => {
  const MockMapView = (props: MockProps) => <View testID="map-view" {...props} />;

  const Marker = (props: MockProps) => <View testID="map-marker" {...props} />;
  const Polyline = (props: MockProps) => <View testID="map-polyline" {...props} />;
  const Circle = (props: MockProps) => <View testID="map-circle" {...props} />;
...
describe('JobMapView', () => {
  it('should render map with job markers', () => {
    const { getAllByTestId } = render(<JobMapView jobs={mockVerificationJobs} />);
  ...
  it('should show job details on marker press', () => {
    const { getAllByTestId, getByTestId } = render(<JobMapView jobs={mockVerificationJobs} />);
  ...
  it('should show inspector current location', () => {
    ...
    const { getByTestId } = render(
      <JobMapView jobs={mockVerificationJobs} currentLocation={currentLocation} />
    );
  ...
  it('should handle map region change', () => {
    ...
    const { getByTestId } = render(
      <JobMapView jobs={mockVerificationJobs} onRegionChange={onRegionChange} />
    );
  ...
  it('should cluster markers when zoomed out', () => {
    ...
    const { getAllByTestId } = render(<JobMapView jobs={manyJobs} />);
