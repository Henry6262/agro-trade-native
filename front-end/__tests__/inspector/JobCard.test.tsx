...
describe('JobCard', () => {
  ...
  it('should display priority badge with correct color', () => {
    const { getByTestId } = render(<JobCard job={mockJob} onPress={mockOnPress} />);
  ...
  it('should show accept button when not assigned', () => {
    const { getByText } = render(<JobCard job={mockJob} onPress={mockOnPress} showAcceptButton />);
  ...
  it('should handle accept button press', () => {
    ...
    const { getByText } = render(
      <JobCard job={mockJob} onPress={mockOnPress} onAccept={mockOnAccept} showAcceptButton />
    );
