...
| `MOB-001` | Mobile onboarding refactor (Page → Section → Feature) | In Progress | Mobile squad | 2025-11-15 | Shared onboarding modules moved to `pages/Onboarding/features/shared/` & `pages/Onboarding/components/shared/`; transporter Jobs/Bidding/Fleet migrated to `pages/Dashboard/sections/Transporter/features/{Jobs,Bidding,Fleet}/`; Inspector Active Job now lives under `pages/Dashboard/sections/Inspector/features/ActiveJob/` with its own service/hook/components. Blueprint: `docs/blueprints/mobile/MOB-001.md` |
