...
| `MOB-001` | Mobile onboarding refactor (Page → Section → Feature) | In Progress | Mobile squad | 2025-11-15 | Shared onboarding modules moved to `pages/Onboarding/features/shared/` & `pages/Onboarding/components/shared/`; transporter Jobs/Bidding/Fleet/Offers/Transfers migrated to `pages/Dashboard/sections/Transporter/features/{Jobs,Bidding,Fleet,Offers,Transfers}/`; inspector Active + Available Jobs now live under `pages/Dashboard/sections/Inspector/features/{ActiveJob,AvailableJobs}/`; buyer Orders + Requests + RequestCreation features rebuilt with dedicated services/hooks/components. Blueprint: `docs/blueprints/mobile/MOB-001.md` |
