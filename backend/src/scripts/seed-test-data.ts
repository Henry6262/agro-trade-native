...
async function main() {
  ...
  for (let i = 1; i <= 5; i++) {
    ...
    console.log(`✅ Created sale listing for ${product.name} by ${seller.name}`);
  }
  ...
  console.log('Transporter emails: transporter1@agrotest.com, transporter2@agrotest.com, transporter3@agrotest.com');
  console.log('Seller emails: seller1@agrotest.com through seller5@agrotest.com');
}
