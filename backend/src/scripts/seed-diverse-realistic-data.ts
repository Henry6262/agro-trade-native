...
const CITY_DATA = [
  ...
  { name: "Montana", region: "North-Western", lat: 43.41, lng: 23.2267 },

  // North-Central Region
  { name: "Pleven", region: "North-Central", lat: 43.417, lng: 24.6167 },
  ...
  { name: "Stara Zagora", region: "South-Central", lat: 42.425, lng: 25.6342 },
...
const BUYER_TEMPLATES = [
  // Large importers
  {
    email: "buyer1@agrocorp.bg",
    name: "AgriCorp International",
    businessName: "AgriCorp International",
    city: "Sofia",
    minQty: 80,
    maxQty: 150,
  },
  {
    email: "buyer2@grainimport.bg",
    name: "Bulgarian Grain Import Ltd",
    businessName: "Bulgarian Grain Import",
    city: "Varna",
    minQty: 60,
    maxQty: 120,
  },
  {
    email: "buyer3@millcompany.bg",
    name: "Plovdiv Mills Co.",
    businessName: "Plovdiv Mills Co.",
    city: "Plovdiv",
    minQty: 50,
    maxQty: 100,
  },
  ...
  // Medium processors
  {
    email: "buyer4@foodprocess.bg",
    name: "Ruse Food Processing",
    businessName: "Ruse Food Processing",
    city: "Ruse",
    minQty: 30,
    maxQty: 70,
  },
  {
    email: "buyer5@organicbulk.bg",
    name: "Organic Bulk Traders",
    businessName: "Organic Bulk BG",
    city: "Burgas",
    minQty: 40,
    maxQty: 80,
  },
  {
    email: "buyer6@starazagora-mill.bg",
    name: "Stara Zagora Mill Group",
    businessName: "SZ Mill Group",
    city: "Stara Zagora",
    minQty: 35,
    maxQty: 75,
  },
  ...
  // Regional buyers
  {
    email: "buyer7@vidin-trade.bg",
    name: "Vidin Agricultural Trade",
    businessName: "Vidin Agro Trade",
    city: "Vidin",
    minQty: 20,
    maxQty: 50,
  },
  {
    email: "buyer8@dobrich-grain.bg",
    name: "Dobrich Grain Cooperative",
    businessName: "Dobrich Grain Co-op",
    city: "Dobrich",
    minQty: 25,
    maxQty: 55,
  },
  {
    email: "buyer9@blagoevgrad-foods.bg",
    name: "Blagoevgrad Foods Ltd.",
    businessName: "Blagoevgrad Foods",
    city: "Blagoevgrad",
    minQty: 30,
    maxQty: 60,
  },
  ...
  // Specialty buyers
  {
    email: "buyer10@premium-grain.bg",
    name: "Premium Grain Solutions",
    businessName: "Premium Grain BG",
    city: "Sofia",
    minQty: 40,
    maxQty: 90,
  },
  {
    email: "buyer11@export-ag.bg",
    name: "Export Agricultural Hub",
    businessName: "Export Ag Hub",
    city: "Varna",
    minQty: 70,
    maxQty: 130,
  },
  {
    email: "buyer12@montana-processing.bg",
    name: "Montana Processing Center",
    businessName: "Montana Processing",
    city: "Montana",
    minQty: 25,
    maxQty: 50,
  },
...
const SELLER_TEMPLATES = [
  // Premium farms
  {
    email: "seller1@organic-farm.bg",
    name: "Ivan Petrov",
    businessName: "Organic Farm Plovdiv",
    city: "Plovdiv",
    verified: true,
    grade: "A",
  },
  {
    email: "seller2@premium-harvest.bg",
    name: "Maria Dimitrova",
    businessName: "Premium Harvest Sofia",
    city: "Sofia",
    verified: true,
    grade: "A",
  },
  {
    email: "seller3@varna-organic.bg",
    name: "Georgi Ivanov",
    businessName: "Varna Organic Farms",
    city: "Varna",
    verified: true,
    grade: "A",
  },
  ...
  {
    email: "seller4@ruse-farms.bg",
    name: "Petar Stoyanov",
    businessName: "Ruse Agricultural Co.",
    city: "Ruse",
    verified: true,
    grade: "B",
  },
  {
    email: "seller5@burgas-harvest.bg",
    name: "Elena Georgieva",
    businessName: "Burgas Harvest Group",
    city: "Burgas",
    verified: true,
    grade: "B",
  },
  {
    email: "seller6@pleven-agro.bg",
    name: "Nikolay Krastev",
    businessName: "Pleven Agro Ltd.",
    city: "Pleven",
    verified: true,
    grade: "B",
  },
  {
    email: "seller7@stara-zagora-farm.bg",
    name: "Dimitar Vasilev",
    businessName: "Stara Zagora Farm",
    city: "Stara Zagora",
    verified: false,
    grade: "B",
  },
  ...
  // Budget farms
  {
    email: "seller8@vidin-grain.bg",
    name: "Stefan Todorov",
    businessName: "Vidin Grain Farm",
    city: "Vidin",
    verified: false,
    grade: "C",
  },
  {
    email: "seller9@dobrich-fields.bg",
    name: "Todor Mihaylov",
    businessName: "Dobrich Fields Co.",
    city: "Dobrich",
    verified: false,
    grade: "C",
  },
  {
    email: "seller10@montana-farm.bg",
    name: "Vasil Angelov",
    businessName: "Montana Farm Products",
    city: "Montana",
    verified: false,
    grade: "C",
  },
  ...
  // Mid-size operations
  {
    email: "seller11@sliven-agri.bg",
    name: "Hristo Petkov",
    businessName: "Sliven Agricultural",
    city: "Sliven",
    verified: true,
    grade: "B",
  },
  {
    email: "seller12@veliko-tarnovo-farm.bg",
    name: "Kamen Ivanov",
    businessName: "Veliko Tarnovo Farm",
    city: "Veliko Tarnovo",
    verified: false,
    grade: "B",
  },
  {
    email: "seller13@blagoevgrad-harvest.bg",
    name: "Lyubomir Kolev",
    businessName: "Blagoevgrad Harvest",
    city: "Blagoevgrad",
    verified: true,
    grade: "A",
  },
  {
    email: "seller14@shumen-grain.bg",
    name: "Veselin Petrov",
    businessName: "Shumen Grain Co.",
    city: "Shumen",
    verified: false,
    grade: "C",
  },
  {
    email: "seller15@yambol-fields.bg",
    name: "Plamen Georgiev",
    businessName: "Yambol Fields Ltd.",
    city: "Yambol",
    verified: true,
    grade: "B",
  },
  ...
  // Small farms
  {
    email: "seller16@pernik-farm.bg",
    name: "Boyan Ivanov",
    businessName: "Pernik Family Farm",
    city: "Pernik",
    verified: false,
    grade: "C",
  },
  {
    email: "seller17@kyustendil-grain.bg",
    name: "Zdravko Petrov",
    businessName: "Kyustendil Grain",
    city: "Kyustendil",
    verified: false,
    grade: "C",
  },
  {
    email: "seller18@pazardzhik-harvest.bg",
    name: "Ivaylo Dimitrov",
    businessName: "Pazardzhik Harvest",
    city: "Pazardzhik",
    verified: true,
    grade: "B",
  },
...
async function main() {
    ...
    for (let i = 0; i < numListings; i++) {
      ...
      await prisma.buyListing.create({
        data: {
          ...
          neededBy: new Date(
            Date.now() + daysUntilNeeded * 24 * 60 * 60 * 1000,
          ),
          status: "ACTIVE",
  ...
  console.log(
    `✅ Created ${buyerCount} buyers with ${buyListingCount} buy listings\n`,
  );
  ...
  for (const template of SELLER_TEMPLATES) {
    ...
    for (let i = 0; i < numListings; i++) {
      ...
      const gradeMultiplier =
        { A: 1.15, B: 1.0, C: 0.85 }[template.grade] || 1.0;
  ...
  console.log(
    `✅ Created ${sellerCount} sellers with ${saleListingCount} sale listings`,
  );
  ...
  console.log(
    `   Buy Listings: ${buyListingCount} (various products and quantities)`,
  );
  console.log(`   Sale Listings: ${saleListingCount} (with specifications)`);
  console.log(
    `   Specifications: ${specificationCount} (moisture, protein, grade, organic)`,
  );
  ...
  console.log(
    "   Buyers: buyer1@agrocorp.bg ... buyer12@montana-processing.bg",
  );
  console.log(
    "   Sellers: seller1@organic-farm.bg ... seller18@pazardzhik-harvest.bg",
  );
}
