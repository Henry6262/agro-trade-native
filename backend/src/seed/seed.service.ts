/**
 * SeedService — idempotent product catalog seed.
 *
 * Runs once on every app startup via OnApplicationBootstrap.
 * If products already exist it exits immediately (no-op).
 * Runs inside the NestJS DI container so it uses the shared
 * PrismaService — no standalone PrismaClient, no hanging process.exit issues.
 */
...
export class SeedService implements OnApplicationBootstrap {
  ...
  private async seedProductCatalog() {
    ...
    if (productCount > 0) {
      this.logger.log(
        `Product catalog already seeded (${productCount} products). Skipping.`,
      );
      return;
    }

    this.logger.log('Seeding product catalog...');
    ...
    const productDefs: ProductDef[] = [
      {
        ...
        name: 'soft_wheat', displayName: 'Soft Wheat',
      ...
      },
      {
        ...
        name: 'durum_wheat', displayName: 'Durum Wheat',
      ...
      },
      {
        ...
        name: 'corn_maize', displayName: 'Corn/Maize',
      ...
      },
      {
        ...
        name: 'barley', displayName: 'Barley',
      ...
      },
      {
        ...
        name: 'sunflower', displayName: 'Sunflower Seeds',
      ...
      },
      {
        ...
        name: 'rapeseed', displayName: 'Rapeseed/Canola',
      ...
      },
      {
        ...
        name: 'soybean_meal', displayName: 'Soybean Meal',
      ...
      },
      {
        ...
        name: 'wheat_bran', displayName: 'Wheat Bran',
      ...
      },
      {
        ...
        name: 'alfalfa', displayName: 'Alfalfa Pellets',
      ...
      },
      {
        ...
        name: 'other', displayName: 'Other Cereals & Oilseeds',
