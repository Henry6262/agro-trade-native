...
const steps = [
  {
    ...
    icon: ClipboardList,
    timing: 'Buyer-led',
    record: 'Signed request and specification',
    accent: B.wheat,
    accentRgb: '216,179,93',
  },
  {
    n: '02',
    ...
    record: 'Reviewer, timestamp and open conditions',
    accent: B.amber,
    accentRgb: '198,129,42',
  },
  {
    n: '03',
    ...
    record: 'Actor, actual time and source evidence',
    accent: B.wheat,
    accentRgb: '216,179,93',
  },
  {
    ...
    record: 'Outcome and AgriTek coordination fee',
    accent: B.amber,
    accentRgb: '198,129,42',
  },
];
  ...
  return (
    <section id="how-it-works" className="relative py-28 px-4 overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 80% 60% at 50% 50%, rgba(232,200,112,0.07) 0%, transparent 65%)',
        }}
      />
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <FadeInUp>
          <div className="text-center mb-16">
            ...
            >
              ...
              <span
                style={{
                  backgroundImage: `linear-gradient(135deg, ${B.wheat}, ${B.cream}, ${B.amber})`,
          ...
          {steps.map((step, i) => {
            ...
            return (
              <div key={step.title} className="relative">
                ...
                {!isLast && (
                  <div
                    className="hidden lg:flex items-center justify-center absolute top-1/2 -right-3 z-20"
                    style={{ transform: 'translateY(-50%)' }}
                  >
                    <span className="text-xl select-none" style={{ color: `${step.accent}55` }}>
                      ›
                    </span>
                  </div>
                )}
                ...
                >
                  ...
                  <div className="flex flex-col gap-4 p-6 h-full">
                    ...
                    <div className="flex-1">
                      <h3 className="text-base font-bold mb-2" style={{ color: B.cream }}>
                        {step.title}
                      </h3>
                    ...
                    <div
                      ...
                      style={{ borderTop: `1px solid rgba(${step.accentRgb},0.16)` }}
                    >
                      <p className="text-xs font-mono" style={{ color: `${B.muted}AA` }}>
                        Record · {step.record}
                      </p>
                    </div>
                  </div>
        ...
        <FadeInUp delay={0.35}>
          ...
          >
            <strong style={{ color: B.cream }}>Transaction boundary:</strong> the exporter sells
            directly to the Spanish buyer, the buyer remains importer of record and pays the
            exporter directly through agreed banking rails. AgriTek never holds customer funds,
            takes title, owns inventory, extends credit, guarantees either party or clears customs.
          </div>
        </FadeInUp>
      </div>
    </section>
